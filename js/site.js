const I18N = {
  pt: {
    ...
    "about.title": "O clube",
    "about.lede": "Não é org. Não é mix. É o nome que ficou no call — do 1.6 ao CS2.",
    ...
    "about.era.source": "Motor novo, mira estranha por um mês, e o mesmo call. A ponte entre o LAN e o matchmaking.",
    ...
    "about.era.more": "Corrida, arcade, RPG, futebol. Quando o CS cansa, o call não desliga.",
    ...
    "about.cities.sub": "Quatro cidades, um call.",
  ...
  en: {
    ...
    "about.lede": "Not an org. Not a mix. It's the name that stuck on the call — from 1.6 to CS2.",
    ...
    "about.era.source": "New engine, weird aim for a month, same call. The bridge between LAN and matchmaking.",
    "about.era.source.map": "de_inferno",
    "about.era.source.server": "css.wtc.br:27015",
    "about.era.go.y": "2012–2022",
    "about.era.go.t": "CS:GO",
    ...
    "about.era.more": "Racing, arcade, RPG, football. When CS wears thin, the call stays on.",
    ...
    "about.cities.sub": "Four cities, one call.",
