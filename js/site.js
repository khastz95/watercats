const I18N = {
  pt: {
    ...
    "hero.lede": "Clube de amigos. O nome atravessa gerações — marcar horário, entrar no lobby e passar a noite em jogo.",
    ...
    "home.roster.sub": "A mesa de agora. Abra uma ficha para ver perfil, números e jogadas.",
    ...
    "home.clips": "Arquivo",
    "home.clipsTitle": "Jogadas",
    "home.clips.sub": "O que alguém gravou. A seleção muda a cada visita; o arquivo completo está na página de jogadas.",
    "home.stats": "Temporada",
    "home.statsTitle": "Números da casa",
    "home.stats.sub": "Rating, partidas, vitórias e Premier dos membros neste momento.",
    "home.hot": "Em fase",
    "home.hot.sub": "Os três melhores ratings deste recorte. Um olhar rápido, não um ranking oficial.",
    "home.now": "Agora",
    "home.story.kicker": "História",
    "home.story.title": "Um clube, várias gerações",
    "home.story.lead": "A Watercats existe há bastante tempo. Pessoas entram, pessoas saem, e o nome continua.",
    "home.story.1.t": "Amigos primeiro",
    ...
    "home.close.kicker": "Lobby",
    "home.close.title": "Quer entrar no lobby?",
    "home.close.lede": "Clube fechado, com peneira. Ou conhece o elenco e as jogadas primeiro.",
    ...
    "about.era.pause": "Pausar",
    "about.era.vote": "Essa foi a minha era",
    "about.era.voted": "Registrado na urna da casa",
    "about.era.votes": "Votos da visita",
    "about.era.stat.years": "Anos",
    "about.era.stat.nights": "Noites",
    "about.era.stat.maps": "Mapa-casa",
    "about.era.stat.server": "Server",
    "about.era.stat.crew": "No lobby",
    "about.era.1.6.y": "2003–2007",
    "about.era.1.6.t": "CS 1.6",
    "about.era.1.6.g": "Geração LAN",
    "about.era.1.6": "Dust2 no LAN house, mic estourado e a tag Watercats aparecendo no nick pela primeira vez.",
    "about.era.1.6.map": "de_dust2",
    "about.era.1.6.server": "wtc.lan:27015",
    "about.era.source.y": "2008–2011",
    "about.era.source.t": "CS:Source",
    "about.era.source.g": "Geração CSS",
    "about.era.source": "Motor novo, mira estranha por um mês, e o mesmo lobby. A ponte entre o LAN e o matchmaking.",
    "about.era.source.map": "de_inferno",
    "about.era.source.server": "css.wtc.br:27015",
    "about.era.go.y": "2012–2022",
    "about.era.go.t": "CS:GO",
    "about.era.go.g": "Geração GO",
    "about.era.go": "FACEIT, Premier antigo, clipes e várias gerações no mesmo nome. Quem entrou e quem saiu — a tag ficou.",
    "about.era.go.map": "de_mirage",
    "about.era.go.server": "faceit · gc",
    ...
    "about.era.more.g": "Noite livre",
    "about.era.more": "Corrida, arcade, RPG, futebol. Quando o CS cansa, o lobby não desliga.",
    "about.era.more.map": "qualquer",
    "about.era.more.server": "party · voice",
    "about.era.reply.1.6": "LAN no sangue. A urna bateu pra você.",
    "about.era.reply.source": "CSS na veia. Ponte confirmada.",
    "about.era.reply.go": "Geração GO. Clipou e voltou.",
    "about.era.reply.cs2": "Mesa atual. Bem-vindo ao motor novo.",
    ...
    "join.aside": "Clube fechado. Entra quem for escolhido — sem limite de vagas, mas com peneira.",
    "join.point1": "Pedido vai pro painel",
    "join.point2": "Resposta no Discord ou Steam",
    "join.point3": "Só entra quem for peneirado",
    "join.who": "Quem é você",
    "join.name": "Nome",
    "join.nick": "Nick",
    "join.city": "Cidade",
    "join.role": "Função",
    "join.namePh": "Nome completo",
    "join.nickPh": "Seu nick no jogo",
    "join.cityPh": "Cidade, UF",
    "join.rolePh": "AWP, rifler, IGL…",
    "join.contact": "Como achar você",
    "join.discord": "Discord",
    "join.email": "E-mail",
    "join.steamId": "SteamID64",
    "join.steamUrl": "Link da Steam",
    "join.discordPh": "usuario",
    "join.emailPh": "opcional",
    "join.steamIdPh": "76561198…",
    "join.steamUrlPh": "https://steamcommunity.com/…",
    "join.contactHint": "Pelo menos um: Discord, Steam ou e-mail.",
    "join.game": "Jogo",
    "join.era": "Entrou no CS em qual era?",
    "join.era.empty": "Escolhe…",
    "join.era.more": "Outros",
    "join.message": "Por que quer entrar?",
    "join.messagePh": "Como conheceu o clube, com quem joga, o que busca no lobby…",
    "join.submit": "Enviar pedido",
    "join.sending": "Enviando…",
    "join.okTitle": "Pedido enviado",
    "join.ok": "A gente avalia e responde. Até lá, dá pra conhecer os membros e as jogadas.",
    "join.again": "Enviar outro",
    ...
    "join.note": "Enviar não garante entrada. O clube escolhe.",
    "marca.kicker": "Marca",
    "marca.title": "O que vem pela frente",
    "marca.sub": "Prévia da linha Watercats. Ainda não tem loja — só o que a gente está desenhando para o futuro.",
    "marca.chip1": "Em breve",
    "marca.chip2": "Só visual",
    "marca.chip3": "Avisos",
    "marca.browse": "Ver a vitrine",
    "marca.notify": "Receber avisos",
    "marca.stage": "Vitrine",
    "marca.stageTitle": "Peças da Alliance",
    "marca.stageSub": "Mockups da marca. Sem compra por enquanto — só para olhar o que vem.",
    "marca.soon": "Em breve",
    "marca.preview": "Prévia · sem venda",
    "marca.item.jersey": "Camisa team",
    "marca.item.hoodie": "Blusa / camisa",
    "marca.item.jacket": "Jaqueta",
    "marca.item.cap": "Boné",
    "marca.item.bag": "Mochila e bolsa",
    "marca.item.pad": "Mousepad",
    "marca.item.cups": "Copos",
    "marca.item.pins": "Pins e chaveiro",
    "marca.cat.wear": "Vestuário",
    "marca.cat.gear": "Kit",
    "marca.cat.setup": "Setup",
    "marca.cat.home": "Casa",
    "marca.cat.collect": "Colecionáveis",
    "marca.wait.kicker": "Avisos",
    "marca.wait.title": "Quer saber quando sair?",
    "marca.wait.lede": "Deixa o e-mail. Avisamos quando a linha da marca avançar — sem spam, sem venda agora.",
    "marca.wait.name": "Nome",
    "marca.wait.namePh": "Opcional",
    "marca.wait.email": "E-mail",
    "marca.wait.emailPh": "seu@email.com",
    "marca.wait.submit": "Quero receber avisos",
    "marca.wait.sending": "Enviando…",
    "marca.wait.note": "Só novidades da marca. Pode sair quando quiser.",
    "marca.wait.okTitle": "Anotado",
    "marca.wait.ok": "Quando tiver novidade da marca, a gente avisa nesse e-mail.",
    "marca.wait.again": "Usar outro e-mail",
    "marca.wait.fail": "Não deu pra salvar agora. Tenta de novo em instantes.",
    "marca.wait.needEmail": "Coloca um e-mail válido.",
    "marca.close.kicker": "Clube",
    "marca.close.title": "Enquanto a loja não chega",
    "marca.close.lede": "A história e o pedido de entrada estão do outro lado do site.",
    "clips.all": "Todo mundo",
    "clips.play": "Ver jogada",
    "empty.players": "Nenhum membro cadastrado ainda.",
    "empty.clips": "Ainda não há jogadas neste arquivo.",
    "empty.stats": "Os números aparecem quando a temporada começa a andar.",
  ...
  en: {
    ...
    "hero.kicker": "Watercats · CS2",
    "hero.tagline": "ALLIANCE",
    "hero.lede": "A club of friends. The name spans generations — pick a time, join the lobby, and spend the night in a match.",
    ...
    "home.roster.sub": "The table now. Open a sheet for the profile, stats, and clips.",
    ...
    "home.clips": "Archive",
    "home.clipsTitle": "Clips",
    "home.clips.sub": "What someone recorded. The selection changes every visit; the full archive is on the clips page.",
    "home.stats": "Season",
    "home.statsTitle": "House numbers",
    "home.stats.sub": "Rating, matches, wins, and Premier for the members right now.",
    "home.hot": "In form",
    "home.hot.sub": "The three highest ratings in this cut. A quick look, not an official ranking.",
    "home.now": "Now",
    "home.story.kicker": "Story",
    "home.story.title": "One club, several generations",
    "home.story.lead": "Watercats has been around for a long time. People come in, people leave, and the name stays.",
    "home.story.1.t": "Friends first",
    ...
    "home.close.kicker": "Lobby",
    "home.close.title": "Want into the lobby?",
    "home.close.lede": "Closed club, with a screen. Or meet the roster and clips first.",
    ...
    "about.era.next": "Next",
    "about.era.play": "Play",
    "about.era.pause": "Pause",
    "about.era.vote": "That was my era",
    "about.era.voted": "Logged in the house ballot",
    "about.era.votes": "Visitor votes",
    "about.era.stat.years": "Years",
    "about.era.stat.nights": "Nights",
    "about.era.stat.maps": "Home map",
    "about.era.stat.server": "Server",
    "about.era.stat.crew": "In lobby",
    "about.era.1.6.y": "2003–2007",
    "about.era.1.6.t": "CS 1.6",
    "about.era.1.6.g": "LAN generation",
    "about.era.1.6": "Dust2 in a LAN house, blown-out mics, and Watercats showing up in the nick for the first time.",
    "about.era.1.6.map": "de_dust2",
    "about.era.1.6.server": "wtc.lan:27015",
    "about.era.source.y": "2008–2011",
    "about.era.source.t": "CS:Source",
    "about.era.source.g": "CSS generation",
    "about.era.source": "New engine, weird aim for a month, same lobby. The bridge between LAN and matchmaking.",
    "about.era.source.map": "de_inferno",
    "about.era.source.server": "css.wtc.br:27015",
    "about.era.go.y": "2012–2022",
    "about.era.go.t": "CS:GO",
    "about.era.go.g": "GO generation",
    "about.era.go": "FACEIT, old Premier, clips, and several generations under one name. People came and left — the tag stayed.",
    "about.era.go.map": "de_mirage",
    "about.era.go.server": "faceit · gc",
    ...
    "about.era.more.g": "Free night",
    "about.era.more": "Racing, arcade, RPG, football. When CS wears thin, the lobby stays on.",
    "about.era.more.map": "any",
    "about.era.more.server": "party · voice",
    "about.era.reply.1.6": "LAN in the blood. The ballot hit for you.",
    "about.era.reply.source": "CSS in the veins. Bridge confirmed.",
    "about.era.reply.go": "GO generation. Clipped and came back.",
    "about.era.reply.cs2": "Current table. Welcome to the new engine.",
    ...
    "join.aside": "Closed club. You get in if you're chosen — no hard cap, but every request is screened.",
    "join.point1": "Request goes to the panel",
    "join.point2": "Reply on Discord or Steam",
    "join.point3": "Only screened people get in",
    "join.who": "Who you are",
    "join.name": "Name",
    "join.nick": "Nick",
    "join.city": "City",
    "join.role": "Role",
    "join.namePh": "Full name",
    "join.nickPh": "Your in-game nick",
    "join.cityPh": "City, region",
    "join.rolePh": "AWP, rifler, IGL…",
    ...
    "join.discordPh": "username",
    "join.emailPh": "optional",
    "join.steamIdPh": "76561198…",
    "join.steamUrlPh": "https://steamcommunity.com/…",
    "join.contactHint": "At least one: Discord, Steam, or email.",
    "join.game": "Game",
    "join.era": "Which CS era did you start in?",
    "join.era.empty": "Pick…",
    "join.era.more": "Other",
    "join.message": "Why do you want in?",
    "join.messagePh": "How you found the club, who you play with, what you're looking for in the lobby…",
    "join.submit": "Send request",
    "join.sending": "Sending…",
    "join.okTitle": "Request sent",
    "join.ok": "We'll review it and reply. Until then, check out the members and clips.",
    "join.again": "Send another",
    ...
    "join.note": "Sending doesn't mean you're in. The club chooses.",
    "marca.kicker": "Brand",
    "marca.title": "What's coming next",
    "marca.sub": "A preview of the Watercats line. No shop yet — just what we're sketching for the future.",
    "marca.chip1": "Coming soon",
    "marca.chip2": "Look only",
    "marca.chip3": "Updates",
    "marca.browse": "See the lineup",
    "marca.notify": "Get updates",
    "marca.stage": "Lineup",
    "marca.stageTitle": "Alliance pieces",
    "marca.stageSub": "Brand mockups. No checkout for now — just a look at what's ahead.",
    "marca.soon": "Coming soon",
    "marca.preview": "Preview · not for sale",
    "marca.item.jersey": "Team jersey",
    "marca.item.hoodie": "Hoodie / shirt",
    "marca.item.jacket": "Jacket",
    "marca.item.cap": "Cap",
    "marca.item.bag": "Backpack & duffel",
    "marca.item.pad": "Mousepad",
    "marca.item.cups": "Cups",
    "marca.item.pins": "Pins & keychain",
    "marca.cat.wear": "Apparel",
    "marca.cat.gear": "Gear",
    "marca.cat.setup": "Setup",
    "marca.cat.home": "Home",
    "marca.cat.collect": "Collectibles",
    "marca.wait.kicker": "Updates",
    "marca.wait.title": "Want to know when it drops?",
    "marca.wait.lede": "Leave your email. We'll ping you when the brand line moves forward — no spam, no sales now.",
    "marca.wait.name": "Name",
    "marca.wait.namePh": "Optional",
    "marca.wait.email": "Email",
    "marca.wait.emailPh": "you@email.com",
    "marca.wait.submit": "Keep me posted",
    "marca.wait.sending": "Sending…",
    "marca.wait.note": "Brand news only. You can leave anytime.",
    "marca.wait.okTitle": "You're in",
    "marca.wait.ok": "When there's brand news, we'll send it to this email.",
    "marca.wait.again": "Use another email",
    "marca.wait.fail": "Couldn't save right now. Try again in a moment.",
    "marca.wait.needEmail": "Enter a valid email.",
    "marca.close.kicker": "Club",
    "marca.close.title": "While the shop isn't here",
    "marca.close.lede": "The story and the join request live on the other side of the site.",
    "clips.all": "Everyone",
    "clips.play": "Watch clip",
    "empty.players": "No members listed yet.",
    "empty.clips": "There are no clips in the archive yet.",
    "empty.stats": "Numbers show up once the season gets going.",
...
function pageId() {
  ...
  if (path.startsWith("/marca") || path.startsWith("/produtos")) return "marca";
