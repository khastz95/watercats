const I18N = {
  pt: {
    ...
    "hero.lede": "A tag veio de um grupo de amigos e nunca saiu da fila. Gente nova, gente antiga, a mesma aliança no server. Aqui fica o elenco de agora, as jogadas que gravaram e os números da temporada.",
    "hero.body": "Não é um time que começou ontem. É gente que se conhece, que já jogou outras coisas juntos e ainda marca pra entrar no CS2 no mesmo stack.",
    "hero.note.cs": "CS2",
    ...
    "home.roster.sub": "Os cinco de agora. Abre a ficha se quiser o resto: números, clipes e como cada um tá jogando.",
    "home.strip": "A mesma tag, gerações diferentes. Quem passou deixou o nome; quem tá agora carrega.",
    "star.sub": "Os cinco de agora.",
    "star.hint": "Passe o mouse pra ver o resumo, ou abre a ficha.",
    "home.clips": "Jogadas",
    "home.clips.sub": "Uma roleta do que foi gravado. A cada visita muda. Se quiser o arquivo inteiro, vai na página de jogadas.",
    "home.stats": "Os números",
    "home.stats.sub": "Um retrato da temporada: rating, partidas, vitórias e o que o elenco tá produzindo agora.",
    "home.hot": "Em fase",
    "home.hot.sub": "Os três com o rating mais alto agora. Não é ranking oficial — é um recorte de quem tá jogando bem nesta semana.",
    "home.now": "Agora",
    "home.story.kicker": "A casa",
    "home.story.title": "O que é a Watercats",
    "home.story.lead": "Um time antigo de amigos. A tag passou de geração em geração e o combinado continua o mesmo: entra pra jogar um com o outro.",
    "home.story.1.t": "Amigos de verdade",
    "home.story.1": "A tag não nasceu de um anúncio. Nasceu de uns caras que resolveram jogar juntos e não largar o nome.",
    "home.story.2.t": "Gerações na mesma tag",
    "home.story.2": "Gente entrou, gente saiu. Quem tá agora carrega o mesmo nome de quem passou. A aliança ficou.",
    "home.story.3.t": "Ainda é CS",
    "home.story.3": "Mudou o jogo, mudou a fila. O hábito é o mesmo: marca horário, entra no server, joga a noite.",
    "home.place.kicker": "Fora do server",
    "home.place.title": "Onde a gente se encontra",
    "home.place.body": "Discord pra falar, Steam pra achar o grupo, e a página da origem se alguém quiser a história completa da tag.",
    "home.place.steam": "Grupo na Steam",
  ...
  en: {
    ...
    "hero.kicker": "Watercats · CS2",
    "hero.tagline": "OLD FRIENDS. SAME GAMES.",
    "hero.lede": "The tag started with friends and never left the queue. New names, old names, same alliance in the server. This is where the current roster, the clips they recorded, and the season numbers live.",
    "hero.body": "This isn't a team that started yesterday. It's people who know each other, who already played other games together, and still queue CS2 in the same stack.",
    "hero.note.cs": "CS2",
    ...
    "home.roster.sub": "The five right now. Open a page if you want the rest: numbers, clips, and how each of them is playing.",
    "home.strip": "Same tag, different generations. Whoever passed through left the name; whoever's here now carries it.",
    "star.sub": "The five right now.",
    "star.hint": "Hover for a snapshot, or open the page.",
    "home.clips": "Clips",
    "home.clips.sub": "A reel of what got recorded. It changes every visit. The clips page has the full archive.",
    "home.stats": "The numbers",
    "home.stats.sub": "A snapshot of the season: rating, matches, wins, and what the roster is putting up right now.",
    "home.hot": "In form",
    "home.hot.sub": "The three highest ratings right now. Not an official ranking — just a cut of who's playing well this week.",
    "home.now": "Now",
    "home.story.kicker": "The house",
    "home.story.title": "What Watercats is",
    "home.story.lead": "An old team of friends. The tag passed from one generation to the next, and the deal is still the same: queue up and play with each other.",
    "home.story.1.t": "Real friends",
    "home.story.1": "The tag didn't start with an announcement. It started with people who decided to play together and never dropped the name.",
    "home.story.2.t": "Same tag, new generations",
    "home.story.2": "People came in, people left. Whoever's here now carries the same name as the ones who came before. The alliance stayed.",
    "home.story.3.t": "Still CS",
    "home.story.3": "The game changed, the queue changed. The habit didn't: pick a time, join the server, play the night.",
    "home.place.kicker": "Off the server",
    "home.place.title": "Where we meet",
    "home.place.body": "Discord to talk, Steam to find the group, and the origin page if someone wants the full story of the tag.",
    "home.place.steam": "Steam group",
...
const MARK = "/img/badge.png?v=42";
const WORD = (t) => `/img/wordmark-${t}.png?v=42`;
