const I18N = {
  pt: {
    ...
    "home.now": "Agora",
    "home.story.kicker": "O clube",
    "home.story.title": "Um clube, várias gerações",
    "home.story.lead": "A Watercats existe há bastante tempo. Pessoas entram, pessoas saem, e o nome continua. É um clube de amigos que se encontra para jogar.",
    ...
    "join.lede": "Não é tryout de org. É pedir pra entrar no lobby. Preenche com calma — a gente lê e responde pelo Discord ou Steam.",
    "join.aside": "Cinco na mesa. O clube é pequeno de propósito.",
    "join.point1": "Pedido vai pro painel",
    "join.point2": "Resposta no Discord ou Steam",
    "join.point3": "Sem garantia de vaga",
    ...
    "join.note": "Enviar não garante vaga.",
  ...
  en: {
    ...
    "home.now": "Now",
    "home.story.kicker": "The club",
    "home.story.title": "One club, several generations",
    "home.story.lead": "Watercats has been around for a long time. People come in, people leave, and the name stays. It's a club of friends who meet up to play.",
    ...
    "join.lede": "This isn't an org tryout. It's asking to get in the lobby. Fill it in calmly — we'll read it and reply on Discord or Steam.",
    "join.aside": "Five at the table. The club stays small on purpose.",
    "join.point1": "Request goes to the panel",
    "join.point2": "Reply on Discord or Steam",
    "join.point3": "No guaranteed spot",
    ...
    "join.note": "Sending doesn't guarantee a spot.",
    "clips.all": "Everyone",
